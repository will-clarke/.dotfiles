...
if wk_ok then
    wk.register({
        ...
        ["<leader>"] = {
            ...
            [","] = { ":cprev<CR>", "cprev" },
            s = { function() harpoon.ui:toggle_quick_menu(harpoon:list()) end, "harpoon" },
            a = { function() harpoon:list():append() end, "add harpoon" },
            j = { function() harpoon:list():select(1) end, "harpoon #1" },
            h = { function() harpoon:list():select(2) end, "harpoon #3" },
            k = { function() harpoon:list():select(3) end, "harpoon #2" },
