...
if wk_ok then
	wk.register({
		...
		["<leader>"] = {
			...
			m = {
				name = "Magma",
				i = { "<cmd>MagmaInit<CR>", "initializes Magma" },
				o = { "<cmd>MagmaEvaluateOperator<CR>", "Evaluate the text given by some operator." },
				l = { "<cmd>MagmaEvaluateLine<CR>", "Evaluate the current line." },
				v = { "<cmd>MagmaEvaluateVisual<CR>", "Evaluate the selected text." },
				c = { "<cmd>MagmaEvaluateOperator<CR>", "Reevaluate the currently selected cell." },
				r = { "<cmd>MagmaRestart!<CR>", "Shuts down and restarts the current kernel." },
				x = { "<cmd>MagmaInterrupt<CR>", "Interrupts " },
			},
			r = {
				name = "Runner",
