...
spoon.ShiftIt:bindHotkeys({
  left = {{ 'ctrl', 'alt', 'cmd', 'shift' }, 'h' },
  right = {{ 'ctrl', 'alt', 'cmd', 'shift' }, 'l' },
  up = {{ 'ctrl', 'alt', 'cmd', 'shift' }, 'k' },
  down = {{ 'ctrl', 'alt', 'cmd', 'shift' }, 'j' },
  ...
  toggleZoom = {{ 'ctrl', 'alt', 'cmd', 'shift' }, 'z' },
  center = {{ 'ctrl', 'alt', 'cmd', 'shift' }, 'c' },
